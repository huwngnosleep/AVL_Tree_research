...
- Nếu v làm tăng nhiều cao của u, thực hiện xoay để cân bằng cây. Có 4 trường hợp xoay
  - LEFT-HEAVY (chèn làm tăng chiều cao cây con trái): 
    - RIGHT ROTATION (Case LL)
    - LEFT-RIGHT ROTATION (Case LR)
  - RIGHT-HEAVY (chèn làm tăng chiều cao cây con phải):
    - LEFT ROTATION (Case RR)
